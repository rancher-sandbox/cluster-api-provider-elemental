...
//+kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=elementalclustertemplates,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=elementalclustertemplates/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=elementalclustertemplates/finalizers,verbs=update
...
func (r *ElementalClusterTemplateReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&infrastructurev1beta3.ElementalClusterTemplate{}).
		Complete(r)
}
