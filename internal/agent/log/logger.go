...
func Info(msg string, keysAndValues ...any) {
	log.V(InfoLevel).Info(msg, keysAndValues...)
}

func Infof(format string, values ...any) {
	log.V(InfoLevel).Info(fmt.Sprintf(format, values...))
}
...
func Debugf(format string, values ...any) {
	log.V(DebugLevel).Info(fmt.Sprintf(format, values...))
}
...
func Errorf(err error, format string, values ...any) {
	log.Error(err, fmt.Sprintf(format, values...))
}
